...
%prep
%setup -q -n zope.deferredimport-5.0
cd %{_builddir}/zope.deferredimport-5.0
pushd ..
cp -a zope.deferredimport-5.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1688056223
...
cp %{_builddir}/zope.deferredimport-%{version}/LICENSE.txt %{buildroot}/usr/share/package-licenses/pypi-zope.deferredimport/a0b53f43aab58b46bf79ba756c50771c605ab4c5 || :
